 ...
 * generated in the com.txu.registrationapp.soapservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServicePlans_QNAME = new QName("http://soap.service.registration.txu.com/", "getServicePlans");
    private final static QName _GetServicePlansResponse_QNAME = new QName("http://soap.service.registration.txu.com/", "getServicePlansResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.txu.registrationapp.soapservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.service.registration.txu.com/", name = "getServicePlans")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.service.registration.txu.com/", name = "getServicePlansResponse")
